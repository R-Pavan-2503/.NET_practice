...
//         // Variables: 0 ≤ x ≤ 1, 0 ≤ y ≤ 2
//         Variable x = solver.MakeNumVar(0.0, 1.0, "x");
//         Variable y = solver.MakeNumVar(0.0, 2.0, "y");

//         // Constraint: x + y ≤ 2
//         Constraint c = solver.MakeConstraint(double.NegativeInfinity, 2.0, "c");
...
//         {
//             Console.WriteLine(status == Solver.ResultStatus.FEASIBLE
...
//         Console.WriteLine($"Wall time (ms): {solver.WallTime()}  Iterations: {solver.Iterations()}");
//     }
// }
